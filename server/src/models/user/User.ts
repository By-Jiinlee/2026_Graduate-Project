...
User.init(
  {
    ...
    is_email_verified: { type: DataTypes.TINYINT, allowNull: false, defaultValue: 0 },
    is_locked: { type: DataTypes.TINYINT, allowNull: false, defaultValue: 0 },
    status: { type: DataTypes.ENUM('active', 'dormant', 'withdrawn'), allowNull: false, defaultValue: 'active' },
    terms_agreed: { type: DataTypes.TINYINT, allowNull: false, defaultValue: 0 },
    privacy_agreed: { type: DataTypes.TINYINT, allowNull: false, defaultValue: 0 },
    location_agreed: { type: DataTypes.TINYINT, allowNull: false, defaultValue: 0 },
    age_agreed: { type: DataTypes.TINYINT, allowNull: false, defaultValue: 0 },
    marketing_agreed: { type: DataTypes.TINYINT, allowNull: false, defaultValue: 0 },
